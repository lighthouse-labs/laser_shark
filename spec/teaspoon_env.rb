Teaspoon.configure do |config|
  ...
  config.asset_paths = ["spec/javascripts", "spec/javascripts/stylesheets", "public/uploads/student/spec"]
  ...
  config.suite do |suite|
    ...
    suite.matcher = "{spec/javascripts,app/assets,public/uploads/student}/**/*_spec.{js,js.coffee,coffee}"
